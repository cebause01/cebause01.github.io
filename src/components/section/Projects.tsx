  ...
  const projects: ProjectCard[] = [
    {
      ...
      description:
        'Digital healthcare platform for Peritoneal Dialysis patient reporting with AI-powered weekly assessments and doctor-facing insights.',
      technologies: ['AI/ML', 'Healthcare', 'Patient monitoring', 'Data analytics'],
      icon: encodeURI('/images/Screenshot 2025-12-12 090654.png'),
      detailsUrl: 'https://idialysis.my',
      githubUrl: null,
    },
    {
      title: 'Multi-LLM Chat Application',
      description:
        'AI chat app comparing responses from five models via OpenRouter, with judging, images, and file uploads.',
      technologies: ['React', 'Node.js', 'OpenRouter API', 'Multi-model AI'],
      icon: encodeURI('/images/image.png'),
      detailsUrl: 'https://github.com/cebause01/Multi-LLM',
      githubUrl: 'https://github.com/cebause01/Multi-LLM',
    },
    {
      title: 'LLM Fine-Tuning & Model Deployment',
      description:
        'Fine-tuning with Unsloth, GGUF conversion, Ollama deployment, and models published on Hugging Face (AuraAI, ZarifAI).',
      technologies: ['Unsloth', 'GGUF', 'Ollama', 'Hugging Face', 'PyTorch'],
      icon: encodeURI('/images/image copy.png'),
      detailsUrl: 'https://huggingface.co/zarifhaikal01',
      githubUrl: 'https://huggingface.co/zarifhaikal01',
    },
    {
      title: 'Real-Time Sign Language Translator',
      description:
        'YOLOv8 gesture detection from webcam with custom data, Roboflow augmentation, OpenCV, and PyTorch.',
      technologies: ['YOLOv8', 'OpenCV', 'Python', 'PyTorch', 'Roboflow'],
      icon: encodeURI('/images/pastedimage-tz8g-300h.png'),
      detailsUrl: 'https://github.com/cebause01/RT-SignLanguage-YOLOv8',
      githubUrl: 'https://github.com/cebause01/RT-SignLanguage-YOLOv8',
    },
    {
      title: 'Hospital Database Management System',
      description:
        'Oracle-based hospital DBMS for patient records, appointments, and streamlined healthcare operations.',
      technologies: ['Oracle', 'SQL', 'Database design', 'PL/SQL'],
      icon: encodeURI('/images/pastedimage-wghe-400w.jpeg'),
      detailsUrl: 'https://www.linkedin.com/in/zarifhaikalz/',
      githubUrl: null,
    },
    {
      title: 'Google Maps Data Scraper',
      description:
        'JavaScript tooling to extract business data from Google Maps for research and automation workflows.',
      technologies: ['JavaScript', 'Web scraping', 'Automation', 'Data extraction'],
      icon: comingSoon,
      detailsUrl: 'https://github.com/cebause01/GMap_Scrape',
      githubUrl: 'https://github.com/cebause01/GMap_Scrape',
    },
    {
      title: 'Telegram Data Scraper',
      description:
        'Python automation for Telegram data collection using APIs and async-friendly pipelines.',
      technologies: ['Python', 'Telegram API', 'Automation', 'Async I/O'],
      icon: comingSoon,
      detailsUrl: 'https://github.com/cebause01/Scrape_Tele',
      githubUrl: 'https://github.com/cebause01/Scrape_Tele',
    },
    {
      title: 'PDF Processor',
      description:
        'Python utilities for PDF text extraction, merging, splitting, and batch document workflows.',
      technologies: ['Python', 'PDF libraries', 'Text extraction', 'Automation'],
      icon: comingSoon,
      detailsUrl: 'https://github.com/cebause01/PDFProcessor',
      githubUrl: 'https://github.com/cebause01/PDFProcessor',
    },
  ];
              ...
              <Card key={index} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 relative" style={{
                ...
                <CardContent style={{ display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div className="flex gap-3" style={{ marginTop: 'auto', paddingTop: '8px' }}>
                    {isExternalUrl(project.detailsUrl) ? (
                      <a
                        ...
                        aria-label={`View ${project.title} details (opens in new tab)`}
                      >
                    ...
                    {project.githubUrl ? (
                      <a href={project.githubUrl} className="project-btn-outline flex items-center gap-1" style={{ textDecoration: 'none' }} target="_blank" rel="noopener noreferrer" aria-label={`Open ${project.title} repository or external link`}>
